...
void drv_thread_entry(void)
{
    ...
    while (1)
    {
       ...
       if((usMuxResults[37] >= ADC_MINIMUM_IN) && (usMuxResults[29] <= ADC_MINIMUM_IN) && (usMuxResults[47] <= ADC_MINIMUM_IN))
       {
        ...
        if ((usMuxResults[17] >= ADC_MINIMUM_IN) || (usMuxResults[26] >= ADC_MINIMUM_IN))
        {
...
void LiftUp()
{
    switch(ucRunUp)
    {
        ...
        case 9:
            ...
            break;
        case 10:
            g_ioport.p_api->pinWrite(IOPORT_PORT_07_PIN_13, IOPORT_LEVEL_HIGH); // Up Contactor 1
            ucRunUp++;
            break;
        case 11:
            tx_thread_sleep(INTER_RELAY_DELAY);
...
void LiftStop()
{
    ...
    g_ioport.p_api->pinWrite(IOPORT_PORT_07_PIN_12, IOPORT_LEVEL_LOW); // Up Contactor 1
...
int callfloor2()
{
    ...
    current_floor=1;
    ucRun=0;
    if((coming_down==1) || (call==1) || ((usMuxResults[29] >= ADC_MINIMUM_IN) && (usMuxResults[47] >= ADC_MINIMUM_IN)) || ((usMuxResults[2] >= ADC_MINIMUM_IN) && (usMuxResults[65] <= ADC_MINIMUM_IN)))
    {
...
int callfloor_2()
{
    ...
    current_floor=1;
    ucRun=0;
    if((coming_down==1) || (call_1==11) || ((usMuxResults[29] >= ADC_MINIMUM_IN) && (usMuxResults[47] >= ADC_MINIMUM_IN)) || ((usMuxResults[2] >= ADC_MINIMUM_IN) && (usMuxResults[65] <= ADC_MINIMUM_IN)))
    {
...
void stoppinglift(int num)
{
    ...
    {
        if (((usMuxResults[29] >= ADC_MINIMUM_IN) && (usMuxResults[47] >= ADC_MINIMUM_IN) && (usMuxResults[37] >= ADC_MINIMUM_IN)) || ((usMuxResults[17] >= ADC_MINIMUM_IN)&& (usMuxResults[37] >= ADC_MINIMUM_IN)) || ((usMuxResults[26] >= ADC_MINIMUM_IN)&& (usMuxResults[37] >= ADC_MINIMUM_IN)) || ((usMuxResults[37] <= ADC_MINIMUM_IN)))
        {
    ...
    {
        if (((usMuxResults[2] >= ADC_MINIMUM_IN) && (usMuxResults[65] >= ADC_MINIMUM_IN) && (usMuxResults[63] >= ADC_MINIMUM_IN)) || ((usMuxResults[17] >= ADC_MINIMUM_IN) && (usMuxResults[63] >= ADC_MINIMUM_IN)) || ((usMuxResults[26] >= ADC_MINIMUM_IN)&& (usMuxResults[63] >= ADC_MINIMUM_IN)) || ((usMuxResults[63] <= ADC_MINIMUM_IN)))
        {
            if((number!=5) && (number1!=6))
            {
                LiftStop();
    ...
    {
        if (((usMuxResults[56] >= ADC_MINIMUM_IN) && (usMuxResults[11] >= ADC_MINIMUM_IN) && (usMuxResults[0] >= ADC_MINIMUM_IN)) || ((usMuxResults[17] >= ADC_MINIMUM_IN)&& (usMuxResults[0] >= ADC_MINIMUM_IN)) || ((usMuxResults[26] >= ADC_MINIMUM_IN)&& (usMuxResults[0] >= ADC_MINIMUM_IN)) || ((usMuxResults[0] <= ADC_MINIMUM_IN)))
        {
            if((number!=5) && (number1!=6))
            {
                LiftStop();
    ...
    {
        if (((usMuxResults[20] >= ADC_MINIMUM_IN) && (usMuxResults[38] >= ADC_MINIMUM_IN) && (usMuxResults[41] >= ADC_MINIMUM_IN)) || ((usMuxResults[17] >= ADC_MINIMUM_IN)&& (usMuxResults[41] >= ADC_MINIMUM_IN)) || ((usMuxResults[26] >= ADC_MINIMUM_IN)&& (usMuxResults[41] >= ADC_MINIMUM_IN)) || ((usMuxResults[41] <= ADC_MINIMUM_IN)))
        {
            if((number!=5) && (number1!=6))
            {
                LiftStop();
